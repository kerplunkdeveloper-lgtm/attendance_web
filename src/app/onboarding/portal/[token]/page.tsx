...
export default function CandidatePortalPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#090d16] text-slate-200 flex flex-col items-center justify-center p-4">
  ...
  if (error || !candidate) {
    return (
      <div className="min-h-screen bg-[#090d16] text-slate-200 flex flex-col items-center justify-center p-4 text-center">
        ...
        <p className="text-xs text-slate-400 max-w-sm">{error || "Invalid candidate link."}</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#090d16] text-slate-100 p-4 sm:p-8 flex justify-center bg-mesh-radial">
      <div className="w-full max-w-3xl space-y-6">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-slate-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-black text-white">WorkPulse Onboarding Portal</h1>
              <p className="text-xs text-slate-400">Digital Candidate Journey & Offer Acceptance</p>
            </div>
          </div>
        ...
        <div className="glass-card rounded-3xl p-6 sm:p-8 border border-slate-800 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
            <div className="p-4 rounded-2xl bg-slate-900/80 border border-slate-800">
              ...
              <span className="text-base font-bold text-white">{candidate.designation}</span>
            </div>
            <div className="p-4 rounded-2xl bg-slate-900/80 border border-slate-800">
              <span className="text-[11px] font-semibold text-slate-400 uppercase block mb-1">
                Offered Annual CTC
            ...
            {!isAccepted && !isRejected && (
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="px-4 py-2 rounded-xl text-xs font-semibold bg-rose-500/20 hover:bg-rose-500/30 text-rose-300 border border-rose-500/30 transition"
                >
                  Decline
                </button>
                <button
                  ...
                  disabled={isResponding}
                  className="px-6 py-2.5 rounded-xl text-xs font-bold bg-emerald-600 hover:bg-emerald-500 text-white shadow-lg shadow-emerald-600/20 transition flex items-center gap-1.5"
                >
        ...
        <div className="glass-card rounded-3xl p-6 sm:p-8 border border-slate-800 space-y-6">
          ...
          <form onSubmit={handleDocumentUpload} className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800 space-y-4">
            ...
            <div className="flex justify-end">
              <button
                ...
                className="px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-xs flex items-center gap-2 shadow transition"
              >
              ...
              candidate.documents.map((doc) => (
                ...
                >
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="font-semibold text-white">{doc.documentType.replace(/_/g, " ")}</span>
                  </div>
                  <span
